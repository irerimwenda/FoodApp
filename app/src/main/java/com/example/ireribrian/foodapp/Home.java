...
import com.example.ireribrian.foodapp.Model.Category;
import com.example.ireribrian.foodapp.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_fullname.setText(Common.currentUser.getName());
    ...
    private void loadMenu() {
        ...
        FirebaseRecyclerAdapter<Category, MenuViewHolder> adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class, R.layout.menu_item, MenuViewHolder.class, category) {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                viewHolder.textMneuName.setText(model.getName());
